...
const InputComponent = React.forwardRef<HTMLInputElement, React.ComponentProps<'input'>>(
  ({ className, ...props }, ref) => (
    <Input
      ...
      autoCapitalize="off"
      spellCheck="false"
      className={cn('h-full rounded-s-none rounded-e-lg', className)}
      {...props}
      ref={ref}
    />
  ),
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="bg-muted flex h-full min-h-0 gap-1 rounded-s-lg rounded-e-none border-r-0 px-3 focus:z-10"
          disabled={disabled}
        >
