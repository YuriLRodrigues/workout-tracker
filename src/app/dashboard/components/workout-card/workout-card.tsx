  ...
  return (
    <Button asChild variant="outline">
      <Link href={href} className="flex flex-col items-center gap-1">
        ...
        <span className="line-clamp-2 text-center text-wrap break-all first-letter:uppercase">{name}</span>
        <span className="text-muted-foreground line-clamp-2 text-center text-xs text-wrap break-all first-letter:uppercase">
          {description}
        </span>
      </Link>
    </Button>
